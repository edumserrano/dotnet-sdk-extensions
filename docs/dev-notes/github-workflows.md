...
2) On ubuntu-latest, generates code coverage and uploads it as an workflow artifact.
3) On ubuntu-latest, generates NuGet packages and uploads them as an workflow artifact.
