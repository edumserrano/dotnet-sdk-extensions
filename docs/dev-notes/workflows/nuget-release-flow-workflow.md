...
When the last workflow for the NuGet release completes successfully, this workflow is also responsible for closing the [GitHub issue created for the NuGet release](TODO).
