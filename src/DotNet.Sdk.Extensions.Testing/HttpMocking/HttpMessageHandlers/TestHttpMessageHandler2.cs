...
namespace DotNet.Sdk.Extensions.Testing.HttpMocking.HttpMessageHandlers
{
    ...
    /// </summary>
    public class TestHttpMessageHandler2 : DelegatingHandler
    {
        ...
        public TestHttpMessageHandler2 MockHttpResponse(Action<HttpResponseMessageMockBuilder> configure)
        {
        ...
        /// <returns>The <see cref="TestHttpMessageHandler"/> for chaining.</returns>
        public TestHttpMessageHandler2 MockHttpResponse(HttpResponseMessageMock httpResponseMock)
        {
