...
namespace DotNet.Sdk.Extensions.Testing.Tests.HttpMocking.InProcess
{
    public class TimeoutTests : IClassFixture<TimeoutHttpResponseMockingWebApplicationFactory>
    {
        ...
        ///
        /// In this test the timeout of 1 second defined on the mock is higher than the timeout of 50ms defined
        /// on the HttpClient.
        /// </summary>
        [Fact]
        ...
        /// the lowest timeout will be triggered first.
        ///
        /// In this test the timeout of 1ms defined on the mock is lower than the timeout of 50ms defined
        /// on the HttpClient.
        /// </summary>
        [Fact]
